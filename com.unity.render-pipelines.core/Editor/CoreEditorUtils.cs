...
namespace UnityEditor.Rendering
{
    ...
    public static class CoreEditorUtils
    {
        ...
        /// <param name="isError">If the texture to load is the error one, otherwise it will be warning texture</param>
        /// <returns>a <see cref="Texture2D"/></returns>
        public static Texture2D LoadConsoleIcon(bool isError)
        {
